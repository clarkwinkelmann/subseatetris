<?php
	...
	$T_Home = "Home";
	$T_Stats = "Stats";
	$T_HowToPlay = "Wie spielen";
	$T_MoreInfos = "Mehr infos";
	$T_BugnPlay = "Siehe auf BugnPlay";
	$T_NoJS = "<p>Sie müssen Javascript in Ihrem Browser aktivieren, um SubSea Tetris zu spielen !</p>
	<p>Sie wissen nicht wie? <a href=\"http://www.enable-javascript.com/de/\" target=\"_blank\">Befolgen Sie diese Anweisungen</a> und dann aktualisieren Sie die Seite.</p>";
	...
	<p>Wenn Sie Glück haben, bekommen Sie ein Stück Geist. Es geht durch die anderen und ermöglicht es Ihnen, eine Linie am unteren Rand des Rasters zu vervollständigen.</p>";
	$T_OnMobile = "Auch auf Smartphone&nbsp;/&nbsp;Tablet&nbsp;!";
	
	$T_Goal = "Ziel des Spiels";
	$T_Keys = "Tasten";	
	$T_HowToPlay_Enter = "Spiel staren";
	$T_HowToPlay_Esc = "Pause";
	$T_HowToPlay_N = "Neues Spiel";
	...
	$T_Touch_Rotate = "Berühren Sie die linke oder rechte Seite zu drehen";
	$T_Touch_Swipe = "Swipe nach unten zu beschleunigen";
