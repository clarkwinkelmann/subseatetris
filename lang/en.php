<?php
	...
	$T_Text_Home_End = "<p class=\"center\">End of game !</p>";
	...
	$T_Months = "['January','February','March','April','Mai','June','July','Aout','September','October','November','December']";
	$T_NoScore = "No score";
