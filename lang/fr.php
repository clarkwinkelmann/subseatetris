<?php
	...
	$T_Home = "Home";
	$T_Stats = "Stats";
	$T_HowToPlay = "Comment jouer";
	$T_MoreInfos = "Plus d'infos";
	$T_BugnPlay = "Voir sur BugnPlay";
	$T_NoJS = "<p>Vous devez activer javascript dans votre navigateur pour pouvoir jouer à SubSea Tetris !<p>
	<p>Vous ne savez pas comment faire ? <a href=\"http://www.enable-javascript.com/fr/\" target=\"_blank\">Suivez ces instructions</a> puis actualisez la page.</p>";
	...
	<p>Si vous avez de la chance, vous récupérerez une pièce fantôme. Elle passe à travers les autres et vous permet de compléter une ligne au fond de la grille.</p>";
	$T_OnMobile = "Aussi sur smartphone&nbsp;/&nbsp;tablette&nbsp;!";
	
	$T_Goal = "But du jeu";
	$T_Keys = "Touches";
	$T_HowToPlay_Enter = "Commencer une partie";
	$T_HowToPlay_Esc = "Mettre le jeu en pause";
	$T_HowToPlay_N = "Nouvelle partie";
	...
	$T_Touch_Rotate = "Toucher à gauche ou à droite pour tourner";
	$T_Touch_Swipe = "Glisser vers le bas pour accélérer";
